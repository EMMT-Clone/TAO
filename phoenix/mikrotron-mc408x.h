...
#define CXP_DEVICE_INFORMATION__type    Unknown
#define CXP_DEVICE_INFORMATION__size    Unknown
#define CXP_DEVICE_INFORMATION__mode    Unknown
#define CXP_DEVICE_INFORMATION__addr    0x8A04

#define CXP_DEVICE_INFORMATION_SELECTOR__kind    Value
#define CXP_DEVICE_INFORMATION_SELECTOR__type    Unknown
#define CXP_DEVICE_INFORMATION_SELECTOR__size    Unknown
#define CXP_DEVICE_INFORMATION_SELECTOR__mode    Unknown
